...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#080a0f] text-slate-100 selection:bg-emerald-500 selection:text-black overflow-hidden">
      {/* Ambient Lighting Gradients */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-gradient-to-b from-emerald-500/15 via-teal-500/5 to-transparent blur-[120px] pointer-events-none" />
      <div className="absolute top-[800px] right-0 w-[500px] h-[500px] bg-cyan-500/10 blur-[140px] pointer-events-none" />

      {/* Navigation */}
      <header className="relative z-50 border-b border-slate-800/80 backdrop-blur-xl bg-[#080a0f]/70 sticky top-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div>
              ...
              <span className="hidden sm:block text-[10px] tracking-widest uppercase text-slate-400 font-semibold -mt-1">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
            ...
            <a href="#nutrition" className="hover:text-emerald-400 transition-colors">Food & Indian Dishes</a>
            <a href="#ai" className="hover:text-emerald-400 transition-colors">Gymin AI</a>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/auth/login"
              className="px-4 py-2.5 rounded-xl border border-slate-700/80 hover:border-slate-500 text-sm font-semibold text-slate-200 transition-all"
            >
              Login
            </Link>
            <Link
              href="/auth/signup"
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-black font-bold text-sm shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2"
            >
      ...
      <section className="relative pt-20 pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-2xl sm:text-3xl font-extrabold bg-gradient-to-r from-emerald-400 via-teal-200 to-cyan-400 bg-clip-text text-transparent">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/auth/signup"
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-black font-extrabold text-base shadow-xl shadow-emerald-500/25 flex items-center justify-center gap-3 transition-all transform hover:scale-[1.02]"
            >
              <span>Start Your Journey</span>
            ...
            <Link
              href="/auth/login"
              className="w-full sm:w-auto px-8 py-4 rounded-2xl glass-panel hover:bg-slate-800/80 border border-slate-700 text-white font-bold text-base flex items-center justify-center gap-2 transition-all"
            >
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            <div className="p-3 rounded-2xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl font-black text-emerald-400">55+</div>
              <div className="text-xs text-slate-400">Exercises with Demos</div>
            </div>
            <div className="p-3 rounded-2xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl font-black text-teal-400">110+</div>
              <div className="text-xs text-slate-400">Foods & Indian Dishes</div>
            </div>
            <div className="p-3 rounded-2xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl font-black text-cyan-400">100%</div>
              <div className="text-xs text-slate-400">Grounded AI Coach</div>
            </div>
            <div className="p-3 rounded-2xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl font-black text-purple-400">Zero</div>
              <div className="text-xs text-slate-400">Cookie-cutter Plans</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 relative mx-auto max-w-5xl">
          <div className="relative rounded-3xl p-6 sm:p-8 glass-panel-glow shadow-2xl border border-emerald-500/30 overflow-hidden">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-slate-400 uppercase">Today's Workout</span>
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">5 exercises · ~55 min</p>
                </div>
                <div className="w-full py-2.5 rounded-xl bg-emerald-500 text-black text-xs font-extrabold text-center flex items-center justify-center gap-1.5 shadow-md shadow-emerald-500/20">
              ...
              <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-slate-400 uppercase">Calories</span>
                  <span className="text-xs font-bold text-emerald-400">1,620 / 2,200 kcal</span>
                </div>
                <div className="space-y-2 text-xs">
                  <div>
                    <div className="flex justify-between text-slate-400 mb-1">
                      <span>Protein</span>
                      <span className="font-bold text-white">105 / 140 g</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-slate-400 mb-1">
                      <span>Carbs</span>
                      <span className="font-bold text-white">160 / 250 g</span>
                    </div>
                    <div className="w-full h-1.5 rounded-full bg-slate-800 overflow-hidden">
              ...
              <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-slate-400 uppercase">Steps Today</span>
                  <span className="text-xs font-bold text-cyan-400">7,450 / 10,000</span>
                </div>
                <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-2.5">
                  ...
                  <p className="text-[11px] text-slate-300 leading-tight">
                    "Alex, you only have 35g protein left to reach your goal. Try grilled chicken or paneer curry for dinner!"
                  </p>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-slate-800/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              ...
              desc: 'Visual animated vector guides highlighting primary and secondary active muscles with safety tips.',
            },
            {
              icon: Footprints,
              color: 'text-amber-400',
              title: 'Step Tracking',
              desc: 'Daily targets, weekly averages, and trend charts designed for future wearable health integrations.',
            },
            {
              icon: Trophy,
            ...
            return (
              <div
                key={idx}
                className="p-6 rounded-3xl bg-slate-900/60 border border-slate-800 hover:border-slate-700 transition-all hover:bg-slate-900/90 group"
              >
      ...
      <section id="nutrition" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-slate-800/60">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 hover:border-emerald-500/40 transition-colors">
                <div className="text-xs font-bold text-white mb-1">{dish.name}</div>
                <div className="text-[11px] text-slate-400">{dish.serving}</div>
                <div className="mt-3 flex items-center justify-between text-xs">
                  <span className="text-emerald-400 font-bold">{dish.cal}</span>
                  <span className="text-slate-300">{dish.p}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="ai" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-slate-800/60">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-slate-900 via-[#0d1424] to-slate-900 border border-emerald-500/20 relative overflow-hidden">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-2.5">
              {[
                ...
                <div key={i} className="px-3.5 py-1.5 rounded-xl bg-slate-800/80 border border-slate-700/80 text-xs text-slate-300 font-medium">
                  "{prompt}"
                </div>
              ))}
            </div>
      ...
      <footer className="border-t border-slate-800/80 bg-slate-950/80 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="text-xs text-slate-500 text-center sm:text-right max-w-md">

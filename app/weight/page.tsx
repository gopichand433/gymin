      ...
      <div className="space-y-8 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-6 rounded-3xl bg-slate-900/90 border border-slate-800 shadow-xl space-y-2">
            ...
            <p className="text-xs text-slate-400">Most recent recorded weigh-in</p>
          </div>

          <div className="p-6 rounded-3xl bg-slate-900/90 border border-slate-800 shadow-xl space-y-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Starting Weight</span>
            <div className="text-3xl font-black text-slate-300">{start} kg</div>
            <p className="text-xs text-slate-400">Baseline established at onboarding</p>
          </div>

          <div className="p-6 rounded-3xl bg-slate-900/90 border border-slate-800 shadow-xl space-y-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Total Net Change</span>
            <div className={`text-3xl font-black flex items-center gap-2 ${change < 0 ? 'text-emerald-400' : 'text-cyan-400'}`}>
              {change < 0 ? <TrendingDown className="w-6 h-6" /> : <TrendingUp className="w-6 h-6" />}
              <span>{change > 0 ? `+${change}` : change} kg</span>
            </div>
            <p className="text-xs text-slate-400">Steady body recomposition</p>
          </div>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-slate-900/80 border border-slate-800 shadow-xl space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400">Consistent multi-week weigh-in trend</p>
            </div>
          </div>
          ...
          <div className="h-64 w-full pt-4">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <YAxis domain={['dataMin - 1', 'dataMax + 1']} stroke="#64748b" fontSize={11} tickLine={false} />
                <Tooltip
                  contentStyle={{
        ...
        <div className="p-6 rounded-3xl bg-slate-900/70 border border-slate-800 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-slate-400">{measurements.length} logs recorded</span>
          </div>
          ...
          <div className="w-full max-w-md bg-[#0a0d14] border border-slate-800 rounded-3xl p-6 space-y-4 shadow-2xl">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-slate-900 border border-slate-800 text-white font-extrabold text-xl focus:border-emerald-400"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 102"
                  className="w-full px-3 py-2 rounded-xl bg-slate-900 border border-slate-800 text-white text-xs focus:border-emerald-400"
                />
              </div>

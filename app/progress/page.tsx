  ...
  return (
    <AppShell>
      <div className="space-y-8 max-w-6xl mx-auto">
        ...
        {insights.length > 0 && (
          <div className="p-5 rounded-3xl bg-gradient-to-r from-emerald-950/40 via-slate-900 to-cyan-950/40 border border-emerald-500/30 shadow-xl space-y-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="p-5 rounded-3xl bg-slate-900/90 border border-slate-800 shadow-xl">
            ...
            <span className="text-[10px] text-emerald-400 font-bold">Sessions Logged</span>
          </div>
        ...
        <div className="p-6 rounded-3xl bg-slate-900/80 border border-slate-800 shadow-xl space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-400">Working weight progression per session</p>
            </div>
        ...
        <div className="p-6 rounded-3xl bg-slate-900/70 border border-slate-800 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-slate-400">All-time max strength records</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            {prs.map((pr: any) => (
              <div
                key={pr.id}
                className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 hover:border-yellow-500/30 transition-colors space-y-2"
              >
                <div className="flex items-center justify-between">
